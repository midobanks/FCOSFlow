      ...
      <div className="space-y-4">
        ...
        <details className="rounded-lg border border-neutral-200 bg-white">
          ...
          <div className="border-t border-neutral-100 px-5 py-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-neutral-500">Lines per shopper</span><span className="font-medium">{results ? formatShoppers(results.capacityPerShopper).toLocaleString() : '—'}</span></div>
